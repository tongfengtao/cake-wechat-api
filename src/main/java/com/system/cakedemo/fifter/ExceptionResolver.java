package com.system.cakedemo.fifter;

import com.alibaba.fastjson.support.spring.FastJsonJsonView;
import com.system.cakedemo.exeception.CodeException;
import com.system.cakedemo.utils.ResultCode;
...
public class ExceptionResolver implements HandlerExceptionResolver{
    ...
    public ModelAndView resolveException(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, Exception e) {
        ...
        for(StackTraceElement element : stackTrace) {
            if(element.getClassName().startsWith("com.system")) {
                ...
                if(!e.getClass().isAssignableFrom(CodeException.class) && !e.getClass().isAssignableFrom(UndeclaredThrowableException.class)) {
                    ...
                    try{
                        ...
                        error.put("code", ResultCode.OTHER_ERROR.getCode());
